    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <p><a href="${pageContext.request.contextPath}/flightlogger/manage/store/${storeInfo.store.id}/modify">
                    <button class="btn btn-sm btn-primary" type="button">Modify Store</button>
                </a></p>
